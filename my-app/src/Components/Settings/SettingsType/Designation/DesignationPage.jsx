...
function DesignationPage() {
  ...
  const HandlecreateDesignation = () => {
    const newData = {
      id: EmployeeDesignation.length + 1,
      Designation: designation,
      Discription: discription,
    };

    setEmployeeDesignation([...EmployeeDesignation, newData]);
  ...
  return (
    <Box sx={{ height: "auto", overflow: "auto", width: "100%" }}>
      <Box sx={{ p: 2, marginTop: "4rem", mb: 2 }}>
        <Box display={isNonMobileScreen ? "flex" : "block"}>
          <Box display={"block"}>
            ...
            <Typography fontSize={11}>
              In the order details section, you can review and manage alll
              orders with their details
            </Typography>
          </Box>
          <br />
          <Box sx={{ display: "flex", marginLeft: "auto" }}>
            ...
            >
              ...
              {isNonMobileScreen ? "Add Designation" : ""}
            </Button>
          </Box>
        </Box>
